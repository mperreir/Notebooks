...
from pysaliency.benchmark.utils import normalize, match_hist
...
def kld(p, q):
    ...
    # https://stackoverflow.com/questions/24913425/pythonfast-efficient-implementation-of-the-kullback-leibler-divergence-for-mult
